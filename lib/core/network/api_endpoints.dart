class ApiEndpoints {
  ...
  static const String createCategory = 'products/category/create';
  static String categoryById(String id) => 'products/category/$id';
  ...
  static String orderStatus(String orderId) => 'products/order/$orderId/status';
  static const String adminAllOrders = 'products/order/all';
