...
import 'package:ecommerce_app_my/views/admin_all_orders_view.dart';
import 'package:ecommerce_app_my/views/admin_dashboard_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: IndexedStack(
          index: _currentIndex,
          children: [
            _buildNavigator(0, const AdminDashboardView()),
            _buildNavigator(1, const AdminAllOrdersView()),
            _buildNavigator(2, const AdminAllFaqsView()),
