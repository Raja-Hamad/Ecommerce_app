...
class AllFaqsView extends StatefulWidget {
  const AllFaqsView({super.key});

  @override
  State<AllFaqsView> createState() => _AllFaqsViewState();
}

class _AllFaqsViewState extends State<AllFaqsView> {
  @override
